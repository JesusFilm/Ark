export const postData = {
  ...
  excerpt:
    '<p>When people talk about the ministry of Jesus, it&#8217;s easy to focus on his miracles. Jesus performed some amazing feats that the world had never seen (and hasn’t seen since). But one of the most exciting things about His ministry was His teaching style. Jesus taught using parables—simple stories intended to impart a spiritual lesson.&hellip; <a class="more-link" href="http://54.204.85.23/2021/03/17/all-the-parables-of-jesus/">Continue reading <span class="screen-reader-text">All the Parables of Jesus</span></a></p>\n',
